 ...
 * @return A function that creates new instances of T with the specified defaults and optional creation-time customizations
 */
inline fun <reified T : Any> objekt(noinline defaultCustomizer: (T.() -> Unit)? = null): ((T.() -> Unit)?) -> T {
